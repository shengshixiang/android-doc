...
system_server 删除 sdcard文件,/storage/emulated/0/htmlhello.html

由于android高版本对权限操作越来越严谨,导致操作不是自己属组的文件,越来越困难.所以要加入对应权限
...
在启动system_server的时候,需要加上everybody group,9997
...
* QSSI.12/system/core/include/cutils/android_filesystem_config.h
